...
namespace ApiMentopoker.Repositories
{
    public class RepositoryEstadisticas 
    {
        ...
        public async Task BorrarPartidasAsync(string Usuario_id)
        {
        ...
        public async Task DeletePartidaAsync(string Partida_id)
        {
        ...
        public async Task<List<RondaModel>> GetRondasAsync(string partida_id)
        {
            ...
            List<RondaModel> rondas = await consulta.ToListAsync();
            return rondas;
        }

        public async Task<List<JugadaModel>> GetJugadasAsync(string ronda_id)
        {
        ...
        public async Task<Models.ConjuntoPartidasUsuario> GetPartidasAsync(string Usuario_id, DateTime? fechaInicio = null, DateTime? fechaFinal = null, string? cell_id = null, int? condicion =null, double? cantidadJugada = null)
            {
            ...
            {
                rondas.AddRange( await this.GetRondasAsync(partidas[i].Partida_id));
               
            }
            for (int i = 0; i < rondas.Count; i++)
            {
                JugadasCalculadasModel jugada =  await this.GetJugadasCalculadasAsync(rondas[i].Ronda_id, cell_id, condicion, cantidadJugada);
                if (jugada != null)
                {
                    jugadas.Add(jugada);
                }
        ...
        public async Task<JugadasCalculadasModel> GetJugadasCalculadasAsync (string ronda_id, string? cell_id = null, int? condicion = null, double? cantidadJugada = null)
        {
        ...
        public async Task<ApiMentopoker.Models.EstadisticasPartidas> GetEstadisticasPartidasAsync(string Usuario_id, DateTime? fechaInicio = null, DateTime? fechaFinal = null)
        {
        ...
        public async Task<ApiMentopoker.Models.EstadisticasJugadas> GetEstadisticasJugadasAsync(string Usuario_id, DateTime? fechaInicio = null, DateTime? fechaFinal = null, string? cell_id = null, int? condicion = null, double? cantidadJugada = null)
            {
