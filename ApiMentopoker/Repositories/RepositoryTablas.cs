...
namespace ApiMentopoker.Repositories
{
    ...
    public class RepositoryTablas
    {
        ...
        public async Task<List<Celda>> GetTablaAsync(int id)
        {
        ...
        public async Task<Boolean> insertPartidaAsync(int[] ids_Jugadas, int[] ids_Rondas, double[] ganancias_Rondas, double[] cantidades_Rondas,
            string[] cell_ids_Jugadas, int[] table_ids_Jugadas, double[] cantidades_Jugadas,
